...
<body>
    <div class="main-wrapper" id="main-wrapper" data-sidebar-position="fixed">
        <!-- ============================================================== -->
        ...
        <!-- Preloader - style you can find in spinners.css -->
        <!-- ============================================================== -->
        <header class="topbar" data-navheader="fixed">
            <!-- ============================================================== -->
            <!-- Navbar scss in header.scss -->
            <!-- ============================================================== -->
            <nav data-navheader="fixed">
                <div class="nav-wrapper" data-navheader="fixed">
                    <!-- ============================================================== -->
                    <!-- Logo you can find that scss in header.scss -->
                    <!-- ============================================================== -->
                    <a href="{{route('home')}}" class="brand-logo" data-navheader="fixed">
                        <span class="icon">
                        {{-- <img class="light-logo" src="{{asset('logo.png')}}"  class="img img-responsive"> --}}
        ...
        <div class="page-wrapper">
            ...
            <!-- Container fluid scss in scafholding.scss -->
            <!-- ============================================================== -->
            <footer class="center-align m-b-30">All Rights Reserved by PT Eklektik Loka Digipreneur <a href="https://elodigi.id">Elodigi</a>.</footer>
        </div>
        <!-- ============================================================== -->
        <!-- Page wrapper scss in scafholding.scss -->
        <!-- ============================================================== -->
